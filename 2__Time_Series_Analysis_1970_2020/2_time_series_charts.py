...
#  Save
plt.savefig('chart_regression_after.png')

print("\nDownloaded 'chart_regression_after.png'")
...
#  Plot data
fig2 = sns.regplot(data=plot_data_regplot2, x='Years Before Historic Designation',
                y='Percent People of Color')
...
#  Save
plt.savefig('chart_regression_before.png')

print("\nDownloaded 'chart_regression_before.png'")
